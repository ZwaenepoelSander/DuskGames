...
type OnChangeEvent = NameAndEvent<OnChangeStateSyncEvent, "stateSync"> | NameAndEvent<OnChangePlayerJoinedEvent, "playerJoined"> | NameAndEvent<OnChangePlayerLeftEvent, "playerLeft"> | NameAndEvent<OnChangeTimeSyncEvent, "timeSync"> | NameAndEvent<OnChangeUpdateEvent, "update">;
...
/** @deprecated Rune is now Dusk! Please use `npx dusk-cli@latest rune-to-dusk` or follow migration guide: https://developers.dusk.gg/docs/move-to-dusk */
...
export { DuskClient, GameOverOptions, GameOverResult, GameStateWithPersisted, Interpolator, InterpolatorLatency, OnChange, OnChangeParams, Player, PlayerId, Players, RuneClient, _default as default };
